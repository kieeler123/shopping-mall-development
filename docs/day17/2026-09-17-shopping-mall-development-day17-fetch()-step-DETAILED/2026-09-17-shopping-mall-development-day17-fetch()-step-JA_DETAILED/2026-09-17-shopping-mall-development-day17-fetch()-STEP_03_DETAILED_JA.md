# Day 17 --- STEP 03. GET Request --- 最大限詳しく説明した版

> **Day 17の大テーマ:** Day 15 HTTP/API + Day 16
> 非同期JavaScriptを`fetch()`とReact Stateへ接続する\
> **STEP 03の目標:** 基本GET
> RequestをMethod、URL、Headers、Bodyの観点から読み、注文一覧取得と結びつける。
...
``` text
Method: GET / URL: /api/orders / Body: なし
```
...
コードなしで説明できればSTEP 03の中心を理解できている。
