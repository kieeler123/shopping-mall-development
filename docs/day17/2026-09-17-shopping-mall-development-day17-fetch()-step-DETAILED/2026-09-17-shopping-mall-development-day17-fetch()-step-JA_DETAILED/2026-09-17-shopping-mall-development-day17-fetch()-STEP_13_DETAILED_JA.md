# Day 17 --- STEP 13. 特定注文GET --- 最大限詳しく説明した版

> **Day 17の大テーマ:** Day 15 HTTP/API + Day 16
> 非同期JavaScriptを`fetch()`とReact Stateへ接続する\
> **STEP 13の目標:** `/orders`
> Collectionと`/orders/:id`個別Resourceの違い、および200/404
> Responseを理解する。
...
`/orders` Collectionと`/orders/:id`個別Resourceの違い、および200/404
Responseを理解する。
...
コードなしで説明できればSTEP 13の中心を理解できている。
