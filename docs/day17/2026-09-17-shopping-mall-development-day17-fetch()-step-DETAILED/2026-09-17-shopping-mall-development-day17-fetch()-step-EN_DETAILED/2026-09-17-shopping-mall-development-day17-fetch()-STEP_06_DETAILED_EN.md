# Day 17 --- STEP 06. response.ok and HTTP Errors --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 06 goal:** Distinguish HTTP 404/500 responses from
> network-level fetch failures and understand why `response.ok` must be
> checked.
