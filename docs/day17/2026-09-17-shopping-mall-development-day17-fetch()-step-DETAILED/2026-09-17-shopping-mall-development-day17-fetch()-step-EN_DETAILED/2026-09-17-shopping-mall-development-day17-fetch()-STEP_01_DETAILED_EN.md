# Day 17 --- STEP 01. localStorage vs API --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 01 goal:** Understand the difference between directly reading
> browser storage and requesting data from a server API over the
> network.
