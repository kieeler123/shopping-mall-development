# Day 17 --- STEP 03. GET Request --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 03 goal:** Read a basic GET request through Method, URL,
> Headers, and Body and connect it to reading the order list.
