# Day 17 --- STEP 18. HTTP Refactor of useOrders --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 18 goal:** Understand responsibility separation when the
> internal data source changes from localStorage to HTTP while
> preserving the component-facing interface.
