# Day 17 --- STEP 09. /orders API Contract --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 09 goal:** Organize the Request/Response agreements for
> GET/POST/PATCH/DELETE on the order resource.
