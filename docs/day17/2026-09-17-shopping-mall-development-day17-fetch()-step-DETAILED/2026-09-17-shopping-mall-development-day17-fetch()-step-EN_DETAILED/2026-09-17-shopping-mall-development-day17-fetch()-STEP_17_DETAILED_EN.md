# Day 17 --- STEP 17. DELETE and 204 --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 17 goal:** Understand a successful `204 No Content` Response
> with no Body and remove the item from State with `filter()`.
