# Day 17 --- STEP 15. createdOrder --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 15 goal:** Understand why State should use the resource
> actually created and returned by the server rather than blindly
> reusing client input.
