# Day 17 --- STEP 11. Loading State --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 11 goal:** Understand why request-in-progress time is
> represented in React State and when loading starts and ends.
