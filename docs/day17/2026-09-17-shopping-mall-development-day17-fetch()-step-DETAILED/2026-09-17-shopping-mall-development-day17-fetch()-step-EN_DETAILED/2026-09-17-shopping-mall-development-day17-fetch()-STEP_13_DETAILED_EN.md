# Day 17 --- STEP 13. GET a Specific Order --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 13 goal:** Understand Collection `/orders` versus individual
> Resource `/orders/:id`, including 200 and 404 responses.
