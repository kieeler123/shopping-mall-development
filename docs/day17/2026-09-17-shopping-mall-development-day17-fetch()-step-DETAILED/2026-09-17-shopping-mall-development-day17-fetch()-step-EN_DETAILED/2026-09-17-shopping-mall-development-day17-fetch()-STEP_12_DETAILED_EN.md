# Day 17 --- STEP 12. Error State --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 12 goal:** Store HTTP/network failures in React State and
> connect them to Error UI while distinguishing
