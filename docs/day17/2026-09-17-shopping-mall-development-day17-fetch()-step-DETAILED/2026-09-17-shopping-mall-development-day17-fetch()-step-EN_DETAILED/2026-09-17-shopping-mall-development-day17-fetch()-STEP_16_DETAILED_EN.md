# Day 17 --- STEP 16. PATCH --- Fully Expanded Version

> **Day 17 theme:** Connect Day 15 HTTP/API and Day 16 asynchronous
> JavaScript to `fetch()` and React State\
> **STEP 16 goal:** Partially update fields such as order status and
> replace the corresponding State item with the returned `updatedOrder`.
...
Partially update fields such as order status and replace the
corresponding State item with the returned `updatedOrder`.
