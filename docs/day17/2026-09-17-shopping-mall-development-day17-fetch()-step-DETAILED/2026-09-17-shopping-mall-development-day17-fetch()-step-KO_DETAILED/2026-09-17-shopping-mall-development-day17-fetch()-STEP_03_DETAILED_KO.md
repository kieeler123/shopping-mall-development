# Day 17 --- STEP 03. GET Request --- 최대한 풀어쓴 버전

> **Day 17 큰 주제:** Day 15 HTTP/API + Day 16 비동기 JavaScript를
> `fetch()`와 React State에 연결하기\
> **STEP 03 핵심 목표:** 기본 GET 요청을 Method, URL, Headers, Body
> 관점에서 읽고 주문 목록 조회와 연결한다.
...
``` text
Method: GET / URL: /api/orders / Body: 없음
```
...
기본 GET 요청을 Method, URL, Headers, Body 관점에서 읽고 주문 목록
조회와 연결한다.
...
이 문장을 코드 없이 설명할 수 있다면 STEP 03의 핵심을 이해한 것이다.
