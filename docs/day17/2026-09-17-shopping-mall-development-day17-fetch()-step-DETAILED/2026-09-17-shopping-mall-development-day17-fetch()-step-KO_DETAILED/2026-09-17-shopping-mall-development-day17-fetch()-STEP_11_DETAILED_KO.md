# Day 17 --- STEP 11. Loading State --- 최대한 풀어쓴 버전

> **Day 17 큰 주제:** Day 15 HTTP/API + Day 16 비동기 JavaScript를
> `fetch()`와 React State에 연결하기\
> **STEP 11 핵심 목표:** 네트워크 요청이 진행 중인 시간을 React State와
> UI로 표현하는 이유와 시작/종료 시점을 이해한다.
...
네트워크 요청이 진행 중인 시간을 React State와 UI로 표현하는 이유와
시작/종료 시점을 이해한다.
...
이 문장을 코드 없이 설명할 수 있다면 STEP 11의 핵심을 이해한 것이다.
