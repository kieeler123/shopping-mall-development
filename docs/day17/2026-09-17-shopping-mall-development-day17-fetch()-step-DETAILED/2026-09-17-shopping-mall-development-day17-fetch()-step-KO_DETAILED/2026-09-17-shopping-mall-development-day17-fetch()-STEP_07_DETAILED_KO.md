# Day 17 --- STEP 07. GET + try/catch --- 최대한 풀어쓴 버전

> **Day 17 큰 주제:** Day 15 HTTP/API + Day 16 비동기 JavaScript를
> `fetch()`와 React State에 연결하기\
> **STEP 07 핵심 목표:** GET 요청의 네트워크 실패와 직접 `throw`한 HTTP
> 실패를 하나의 오류 처리 흐름으로 연결한다.
...
이 문장을 코드 없이 설명할 수 있다면 STEP 07의 핵심을 이해한 것이다.
