# Day 16 --- STEP 20. Day 16 최종 점검과 Day 17 연결

> **이번 STEP의 목표:** Day 16 전체 개념을 fetch 코드에 연결해 실제 구현
> 준비를 끝낸다.
...
`Day 16의 목표`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP 흐름에
...
> **팁**
>
> `Day 16의 목표`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의 실제
> 상황으로 다시 설명해보자.
...
`Request 최종 확인`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP
...
> **팁**
>
> `Request 최종 확인`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의
> 실제 상황으로 다시 설명해보자.

## 4. Response 최종 확인

`Response 최종 확인`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP
흐름에 배치하는 과정이다. 정의 하나를 외우는 것보다 이 개념이 **어느
계층에 있고 어떤 질문에 답하는지**를 이해해야 한다.
...
> **팁**
>
> `Response 최종 확인`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의
> 실제 상황으로 다시 설명해보자.

## 5. CRUD Mapping

`CRUD Mapping`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP 흐름에
배치하는 과정이다. 정의 하나를 외우는 것보다 이 개념이 **어느 계층에
있고 어떤 질문에 답하는지**를 이해해야 한다.
...
> **팁**
>
> `CRUD Mapping`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의 실제
> 상황으로 다시 설명해보자.
...
`자기 설명 문제`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP 흐름에
배치하는 과정이다. 정의 하나를 외우는 것보다 이 개념이 **어느 계층에
있고 어떤 질문에 답하는지**를 이해해야 한다.
...
> **팁**
>
> `자기 설명 문제`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의 실제
> 상황으로 다시 설명해보자.

## 19. 최종 체크리스트

`최종 체크리스트`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP 흐름에
배치하는 과정이다. 정의 하나를 외우는 것보다 이 개념이 **어느 계층에
있고 어떤 질문에 답하는지**를 이해해야 한다.
...
> **팁**
>
> `최종 체크리스트`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의 실제
> 상황으로 다시 설명해보자.

## 20. Day 17 순서

`Day 17 순서`는 이번 STEP의 핵심 개념을 주문 프로젝트의 HTTP 흐름에
배치하는 과정이다. 정의 하나를 외우는 것보다 이 개념이 **어느 계층에
있고 어떤 질문에 답하는지**를 이해해야 한다.
...
> **팁**
>
> `Day 17 순서`를 공부한 뒤 주문 조회·생성·수정·삭제 중 하나의 실제
> 상황으로 다시 설명해보자.
...
1.  `Day 16 최종 점검과 Day 17 연결`을 다른 HTTP 구성요소 전체와 같은
    개념으로 취급하지 않는다.
...
1.  **Day 16 최종 점검과 Day 17 연결**을 코드 없이 자신의 말로
    설명해보자.
...
-   [ ] Day 16 전체 개념을 fetch 코드에 연결해 실제 구현 준비를 끝낸다.
