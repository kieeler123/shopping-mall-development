...
> **이번 STEP의 목표:** 2xx/4xx/5xx와 200/201/204/400/401/403/404/500을
> 실제 처리 결과로 읽는다.
...
## 14. 같은 Endpoint의 여러 결과

`같은 Endpoint의 여러 결과`는 이번 STEP의 핵심 개념을 주문 프로젝트의
...
> **팁**
>
> `같은 Endpoint의 여러 결과`를 공부한 뒤 주문 조회·생성·수정·삭제 중
...
1.  `HTTP Status Code`을 다른 HTTP 구성요소 전체와 같은 개념으로
    취급하지 않는다.
...
1.  **HTTP Status Code**을 코드 없이 자신의 말로 설명해보자.
...
-   [ ] 2xx/4xx/5xx와 200/201/204/400/401/403/404/500을 실제 처리 결과로
    읽는다.
