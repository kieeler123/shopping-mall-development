# Day 16 --- STEP 14. Headers, Body, Content-Type, and Accept

> **Goal of This Step:** Understand HTTP metadata versus message content
> and precisely interpret Content-Type and Accept.
...
`application/json` should be understood as part of one end-to-end
...
## 8. Messages without Bodies

`Messages without Bodies` should be understood as part of one end-to-end
communication model rather than as an isolated definition.
...
## 9. Missing Content-Type does not always fail
...
## 10. Wrong media types and possible 415 responses
...
## 14. Why ordinary order payload belongs in the Body
...
Do not reduce **Headers, Body, Content-Type, and Accept** to a single
memorized keyword. In particular, keep these boundaries clear:
...
1.  What does **Headers, Body, Content-Type, and Accept** mean in the
    order project?
...
-   [ ] I can explain: Understand HTTP metadata versus message content
    and precisely interpret Content-Type and Accept.
...
> **Understand HTTP metadata versus message content and precisely
> interpret Content-Type and Accept.**
