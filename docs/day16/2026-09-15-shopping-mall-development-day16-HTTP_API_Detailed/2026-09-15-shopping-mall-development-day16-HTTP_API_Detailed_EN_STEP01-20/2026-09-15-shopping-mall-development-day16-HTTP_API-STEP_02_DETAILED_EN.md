...
> **Goal of This Step:** Understand that the Client sends Requests, the
> Server returns Responses, and the Server is not the Database.
...
## 2. Why React is the Client here
...
`Request direction` should be understood as part of one end-to-end
...
`Response direction` should be understood as part of one end-to-end
communication model rather than as an isolated definition.
...
## 7. Order lookup across the layers
...
## 8. Why the Client cannot be trusted as the authority
...
## 11. Client validation versus Server validation
...
Do not reduce **Client and Server** to a single memorized keyword. In
...
1.  What does **Client and Server** mean in the order project?
...
-   [ ] I can explain: Understand that the Client sends Requests, the
    Server returns Responses, and the Server is not the Database.
...
> **Understand that the Client sends Requests, the Server returns
> Responses, and the Server is not the Database.**
