# Day 16 --- STEP 11. The Structure of an HTTP Response

> **Goal of This Step:** Separate Status Code, Headers, and Body and
> avoid treating a Response as synonymous with JSON.
...
`Basic Response structure` should be understood as part of one
...
## 9. Error Responses can still have Bodies

`Error Responses can still have Bodies` should be understood as part of
...
## 12. Connecting to the fetch Response object
...
## 13. Why response is not data

`Why response is not data` should be understood as part of one
end-to-end communication model rather than as an isolated definition.
...
Do not reduce **The Structure of an HTTP Response** to a single
...
1.  What does **The Structure of an HTTP Response** mean in the order
    project?
...
-   [ ] I can explain: Separate Status Code, Headers, and Body and avoid
    treating a Response as synonymous with JSON.
...
> **Separate Status Code, Headers, and Body and avoid treating a
> Response as synonymous with JSON.**
