# Day 16 --- STEP 01. Why Do We Need HTTP and APIs?

> **Goal of This Step:** Understand why moving from browser-local
> storage to server-managed data naturally introduces HTTP communication
> and an API boundary.
...
## 1. The architecture we have used so far

`The architecture we have used so far` should be understood as part of
...
## 2. Why localStorage was useful for learning

`Why localStorage was useful for learning` should be understood as part
...
## 3. What becomes difficult in a real service

`What becomes difficult in a real service` should be understood as part
of one end-to-end communication model rather than as an isolated
definition.
...
## 6. Why communication is now necessary

`Why communication is now necessary` should be understood as part of one
...
`Where HTTP enters` should be understood as part of one end-to-end
...
## 8. Where the API enters

`Where the API enters` should be understood as part of one end-to-end
communication model rather than as an isolated definition.
...
## 9. localStorage architecture versus HTTP API architecture

`localStorage architecture versus HTTP API architecture` should be
understood as part of one end-to-end communication model rather than as
an isolated definition.
...
## 10. Why Day 15 Promise concepts return
...
## 11. More failure states appear

`More failure states appear` should be understood as part of one
end-to-end communication model rather than as an isolated definition.
...
## 12. Order-list example

`Order-list example` should be understood as part of one end-to-end
communication model rather than as an isolated definition.
...
## 14. Server Data versus React State
...
## 15. Why an API hides implementation details

`Why an API hides implementation details` should be understood as part
of one end-to-end communication model rather than as an isolated
definition.
...
## 17. The complete Day 16 map

`The complete Day 16 map` should be understood as part of one end-to-end
communication model rather than as an isolated definition.
...
## 18. Previewing Day 17 fetch code
...
Do not reduce **Why Do We Need HTTP and APIs?** to a single memorized
...
1.  What does **Why Do We Need HTTP and APIs?** mean in the order
    project?
...
-   [ ] I can explain: Understand why moving from browser-local storage
    to server-managed data naturally introduces HTTP communication and
    an API boundary.
...
> **Understand why moving from browser-local storage to server-managed
> data naturally introduces HTTP communication and an API boundary.**
