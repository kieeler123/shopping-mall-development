...
> **この STEP の目標:** Request を Method、URL、Headers、Body
> に分解し、それぞれの役割を理解する。
...
`Request の方向`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `Request の方向`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
`URL`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `URL`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
## 7. 一般的な GET API が Request Body を避ける理由
...
`Request を自然言語で読む`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `Request を自然言語で読む`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 11. fetch options との接続
...
1.  **HTTP Request の構造**は注文 Project で何を意味するか？
...
-   [ ] Request を Method、URL、Headers、Body
    に分解し、それぞれの役割を理解する。
