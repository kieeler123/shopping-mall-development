...
> **この STEP の目標:** ブラウザ内の localStorage から Server
> 管理のデータへ移行すると、なぜ HTTP 通信と API
> の境界が必要になるのかを理解する。
...
## 1. これまでの architecture

`これまでの architecture`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `これまでの architecture`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 2. なぜ localStorage は学習に向いていたのか

`なぜ localStorage は学習に向いていたのか`は単独の定義としてではなく、一つの
...
> **ヒント**
>
> `なぜ localStorage は学習に向いていたのか`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 3. 実サービスで不足すること

`実サービスで不足すること`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `実サービスで不足すること`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
`なぜ通信が必要になるのか`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `なぜ通信が必要になるのか`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 7. HTTP はどこで登場するのか

`HTTP はどこで登場するのか`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `HTTP はどこで登場するのか`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 8. API はどこで登場するのか

`API はどこで登場するのか`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `API はどこで登場するのか`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 9. localStorage 構造と HTTP API 構造の比較

`localStorage 構造と HTTP API 構造の比較`は単独の定義としてではなく、一つの
end-to-end HTTP flow の中で理解する。
...
> **ヒント**
>
> `localStorage 構造と HTTP API 構造の比較`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 10. Day 15 の Promise が再登場する理由
...
`失敗状態が増える理由`は単独の定義としてではなく、一つの end-to-end HTTP
flow の中で理解する。
...
> **ヒント**
>
> `失敗状態が増える理由`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
`API が内部実装を隠せる理由`は単独の定義としてではなく、一つの
end-to-end HTTP flow の中で理解する。
...
> **ヒント**
>
> `API が内部実装を隠せる理由`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 16. よくある誤解

`よくある誤解`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `よくある誤解`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 17. Day 16 全体マップ

`Day 16 全体マップ`は単独の定義としてではなく、一つの end-to-end HTTP
flow の中で理解する。
...
> **ヒント**
>
> `Day 16 全体マップ`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 18. Day 17 の fetch コードを先に見る
...
**なぜ HTTP と API が必要なのか？**を一つの keyword
...
1.  **なぜ HTTP と API が必要なのか？**は注文 Project で何を意味するか？
...
> **ブラウザ内の localStorage から Server 管理のデータへ移行すると、なぜ
> HTTP 通信と API の境界が必要になるのかを理解する。**
