# Day 16 --- STEP 20. Day 16 最終確認と Day 17 への接続

> **この STEP の目標:** Day 16 のすべての概念を fetch
> コードへ接続し、実装学習の準備を完了する。
...
`Day 16 の本当の目標`は単独の定義としてではなく、一つの end-to-end HTTP
flow の中で理解する。
...
> **ヒント**
>
> `Day 16 の本当の目標`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 2. Client / Server 最終確認
...
## 3. Request structure 最終確認

`Request structure 最終確認`は単独の定義としてではなく、一つの
...
> **ヒント**
>
> `Request structure 最終確認`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 4. Response structure 最終確認

`Response structure 最終確認`は単独の定義としてではなく、一つの
end-to-end HTTP flow の中で理解する。
...
> **ヒント**
>
> `Response structure 最終確認`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 5. CRUD mapping 最終確認

`CRUD mapping 最終確認`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `CRUD mapping 最終確認`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
## 15. response.json() preview

`response.json() preview`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `response.json() preview`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 16. response.ok preview
...
`自己説明問題`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `自己説明問題`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 19. 最終 checklist

`最終 checklist`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `最終 checklist`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 20. Day 17 の学習順序

`Day 17 の学習順序`は単独の定義としてではなく、一つの end-to-end HTTP
flow の中で理解する。
...
> **ヒント**
>
> `Day 17 の学習順序`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
**Day 16 最終確認と Day 17 への接続**を一つの keyword
...
1.  **Day 16 最終確認と Day 17 への接続**は注文 Project
    で何を意味するか？
