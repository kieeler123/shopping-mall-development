...
> **この STEP の目標:** JSON text と JavaScript runtime value
> を区別し、serialization と parsing の流れを理解する。
...
## 1. JavaScript runtime value

`JavaScript runtime value`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `JavaScript runtime value`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
## 3. JSON が JS object syntax に似ている理由
...
`構文の違い`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `構文の違い`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 5. double quote

`double quote`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `double quote`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 6. function と undefined

`function と undefined`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `function と undefined`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 7. trailing comma

`trailing comma`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `trailing comma`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
## 14. JS Object が Network を瞬間移動するわけではない
...
## 15. response.json() との接続

`response.json() との接続`は単独の定義としてではなく、一つの end-to-end
HTTP flow の中で理解する。
...
> **ヒント**
>
> `response.json() との接続`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
-   [ ] JSON text と JavaScript runtime value を区別し、serialization と
    parsing の流れを理解する。
