...
> **この STEP の目標:** GET を Read と結び付けながら、safe と idempotent
> の正確な意味まで理解する。
...
## 5. 一般的な API が GET Request Body を避ける理由
...
`Safe の意味`は単独の定義としてではなく、一つの end-to-end HTTP flow
の中で理解する。
...
> **ヒント**
>
> `Safe の意味`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 9. Safe は security の意味ではない

`Safe は security の意味ではない`は単独の定義としてではなく、一つの
...
> **ヒント**
>
> `Safe は security の意味ではない`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 10. Idempotent の意味

`Idempotent の意味`は単独の定義としてではなく、一つの end-to-end HTTP
flow の中で理解する。
...
> **ヒント**
>
> `Idempotent の意味`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 11. Response が変わっても idempotent であり得る理由

`Response が変わっても idempotent であり得る理由`は単独の定義としてではなく、一つの
end-to-end HTTP flow の中で理解する。
...
> **ヒント**
>
> `Response が変わっても idempotent であり得る理由`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。
...
1.  **GET と Read**は注文 Project で何を意味するか？
...
-   [ ] GET を Read と結び付けながら、safe と idempotent
    の正確な意味まで理解する。
