...
> **この STEP の目標:** DELETE の削除意味、204/200
> Response、権限確認、idempotency を理解する。
...
## 2. Method と Path で意図を表せる場合

`Method と Path で意図を表せる場合`は単独の定義としてではなく、一つの
...
> **ヒント**
>
> `Method と Path で意図を表せる場合`を読んだ後、注文の取得・作成・更新・削除のどれか一つを使って、自分の言葉で説明してみよう。

## 3. DELETE Body についての正確な注意
...
1.  **DELETE と Delete**は注文 Project で何を意味するか？
...
-   [ ] DELETE の削除意味、204/200 Response、権限確認、idempotency
    を理解する。
