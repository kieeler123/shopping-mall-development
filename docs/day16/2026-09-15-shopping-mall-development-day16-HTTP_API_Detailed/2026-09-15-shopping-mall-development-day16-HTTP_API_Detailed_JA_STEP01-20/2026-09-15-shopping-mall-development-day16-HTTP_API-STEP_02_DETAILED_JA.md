...
> **この STEP の目標:** Client が Request を送り、Server が Response
> を返すこと、そして Server と Database が別の役割であることを理解する。
...
## 11. Client validation と Server validation
...
1.  **Client と Server**は注文 Project で何を意味するか？
...
-   [ ] Client が Request を送り、Server が Response を返すこと、そして
    Server と Database が別の役割であることを理解する。
